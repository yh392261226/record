...
if (isset($_POST['act']) && trim($_POST['act']) == 'action')
{
    ...
    $tmptargetserver = isset($_POST['targetserver']) ? trim($_POST['targetserver']) : '';
                ...
                <div>
                    ...
                    <select name="sourceserver">
                        ...
                        if (!empty($serverlist))
                        {
                            ...
                            {
                                $selected = '';
                                if (isset($_GET['sourceserver']) && intval($_GET['sourceserver']) == $key)
                                {
                ...
                <div>
                    ...
                    <select name="targetserver">
                        ...
                        if (!empty($serverlist))
                        {
                            ...
                            {
                                $selected = '';
                                if (isset($_GET['targetserver']) && intval($_GET['targetserver']) == $key)
                                {
                                    $selected = 'selected="selected"';
                                }
                                echo '<option ' . $selected . ' value="' . $key . '">' . $val['name'] . '</option>';
